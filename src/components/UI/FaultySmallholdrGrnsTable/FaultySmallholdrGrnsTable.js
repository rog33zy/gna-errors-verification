...
export default function FaultySmallholdrGrnsTable(props) {
  ...
  if (rows.length > 0) {
    ...
    contentToShow = (
      ...
      >
        {props.is_faulty_grn
          ? "No errors detected; all Smallholdr grns have corresponding physical copies. You can safely check for the other errors. Thank you."
          : "No errors detected; all physical and Smallholdr grns match. You can safely check for the other errors. Thank you."}
      </p>
    );
  }
