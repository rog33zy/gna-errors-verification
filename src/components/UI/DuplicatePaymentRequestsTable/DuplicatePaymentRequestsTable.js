...
export default function DuplicatePaymentRequestsTable(props) {
  ...
  if (rows.length > 0) {
                  ...
                  >
                    ...
                    <StyledTableCell align="left">
                      <span style={{ fontSize: "12px" }}>
                        {row.gross_quantity__kg_}
                      </span>
                    </StyledTableCell>
                    <StyledTableCell align="left">
                      <span style={{ fontSize: "12px" }}>
                        {row.net_value_of_seed}
                      </span>
                    </StyledTableCell>
                  </StyledTableRow>
                ))}
    ...
    contentToShow = (
      ...
      >
        {props.is_faulty_payments
          ? "No errors detected; there are no faulty payment requests. You can safely check for the other errors. Thank you."
          : "No errors detected; there are no duplicate payment requests. You can safely check for the other errors. Thank you."}
      </p>
    );
  }
